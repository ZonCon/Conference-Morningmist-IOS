...
static NSString *PID = @"16";
#define TEXT_COLOR [UIColor darkGrayColor]
#define TILE_COLOR [UIColor whiteColor]
static NSString *DB_FILENAME = @"zoncon_conference.db";
static NSString *SHARE_MSG = @"ZonCon Conference Morningmist App";
static NSString *SHARE_SUBJECT = @"ZonCon Conference Morningmist App";
static NSString *SHARE_CONTENT = @"Thank you for downoading the ZonCon Conference App!";
static NSString *FEEDBACK_EMAIL_SUBJECT = @"ZonCon Conference Morningmist App Feedback";
...
static NSString *API_ADD_ITEM_VIEWS = @"add_public_item_views";
